#coding:utf-8
database = {'w00t': {'vuln': ['2.4.10', '2.4.16', '2.4.17', '2.4.18', '2.4.19', '2.4.20', '2.4.21']},
            'brk': {'vuln': ['2.4.10', '2.4.18', '2.4.19', '2.4.20', '2.4.21', '2.4.22']},
            ...
            'h00lyshit': {
                'vuln': ['2.6.8', '2.6.10', '2.6.11', '2.6.12', '2.6.13', '2.6.14', '2.6.15', '2.6.16'],
                'cve': '2006-3626',
    ...
    if msg.startswith("linux"):
        ...
        try:
            ...
            for name in database:
                text=database[name]
                for version in text['vuln']:
                    if msg == version:
                        temp=[]
                        Alt=text.get('alt',None)
                        CVE=text.get('cve',None)
                        Source=text.get('mil',None)
                        if result:
                            result+='\n'
                        temp.append(name)
                        if Alt:
...
def help(info):
    if not info.get('level',3) < 4:
        return False
    return "#linux version 根据内核版本查找exp"
